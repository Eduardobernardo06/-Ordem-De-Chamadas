...
/**
 *
 * net.proteanit.sql.DbUtils -> prencher a tabela
 */
public class TelaOS extends javax.swing.JInternalFrame {
    ...
    private void pesquisar_Cliente() {
        ...
        //apelidamos alguns campos pra facilitar a consulta

        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, txtCliPesquisar.getText() + "%");
            //esse porcentagem é equivalente a pesquisa que é realizado no banco de dados
    ...
    private void setar_campos() {
        ...
        //temos que converter para string (usando .toString() )pois trara-se de um objeto  
    }
    ...
    private void emitir_os() {
        ...
        try {
            ...
            pst.setString(2, cboOsSit.getSelectedItem().toString()); //pegamos o objeto "combobox" de nome cboOsSit selecionamos uma das sua opções(objetos) e transformamos em string
            pst.setString(3, txtOsEquip.getText());
            pst.setString(4, txtOsDef.getText());
            pst.setString(5, txtOsServ.getText());
            pst.setString(6, txtOsTec.getText());
            //.replace subtitui virgula pelo ponto
    ...
    private void pesquisar_os() {
        // a linha abixao cria uma caixa de entrada   
        ...
        try {
            ...
            //para capturar o nome da excessão no terminal-System.out.println(e); 
        } catch (Exception e2) {
            //uso o e2 pois o e estou usando em cima
            JOptionPane.showMessageDialog(null, e2);
            //tratr cada excessão de forma mais individual
        }
    }
    ...
    private void imprimir_os(){
        ...
        if(confirma == JOptionPane.YES_OPTION){
            ...
            try {
                    ...
                    //usando a clase HashMap pra criar um filtro
                    HashMap filtro = new HashMap();
                    filtro.put("OS",Integer.parseInt(txtOS.getText()));
                    //lembrando que estamos usando classes de um framework{conjunto de bibliotecas-> para impressão no caso} chamado jaspesoft
                    JasperPrint print = JasperFillManager.fillReport("C:\\Users\\Bernardo\\Documents\\NetBeansProjects\\prjinfox\\src\\MyReports\\OS.jasper",filtro,conexao);
    ...
    private void initComponents() {
        ...
        txtData.setFont(new java.awt.Font("Tw Cen MT", 1, 10)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtCliPesquisar, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btnOsExcluir.setToolTipText("Deletar ordem de serviço");
        ...
        btnOsAlterar.setToolTipText("Atualizar ordem de serviço");
        ...
        btnOsPesquisar.setToolTipText("Pesquisar por ordem de serviço");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtOsTec, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(jLabel11)
                                .addGap(18, 18, 18)
                                .addComponent(txtOsValor, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnOsImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsImprimirActionPerformed
        //chamando o método pra imprimir uma OS
        imprimir_os();
    }//GEN-LAST:event_btnOsImprimirActionPerformed

    private void txtCliPesquisarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCliPesquisarKeyReleased
        // chamando o método para pesuisar clientes 
        pesquisar_Cliente();
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // quando ele carrega o formulário programa uma ação
        //fazemos isso pra evitar um problema no banco de dados 
        //referente aos campos relacionados a esse botões radio serem não nulos ou seja obrigatórios
        rbtOrc.setSelected(true);
        tipo = "Orçamento";
    ...
    private void btnOsExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsExcluirActionPerformed
        //chamando m método para excluir uma os
        excluir_os();
