...
public class TelaUsuario extends javax.swing.JInternalFrame {
    ...
    public TelaUsuario() {
        //isso é um construtor pois não tem palavras chave class e nada de void pra método
        //inicializamos o modo de conexão
        initComponents();
        conexao = ModuloConexao.conector(); //chamo o método conector()

    }

    private void consultar() {
        String sql = "select * from tbusuarios where iduser=?"; //os maiores erros estão na sintaxe dessa linha  
        try {
            ...
            if (rs.next()) {
                ...
                //não limpamos o ID pois o cliente pode criar um novo usuário apartir do que foi deixado
            }
        } catch (Exception e) {
    ...
    //criando o método para alterar dados do usário
    ...
    private void btnUsuReadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUsuReadActionPerformed
        //chamando método consultar-quando o botão for clicado
        consultar();
